...
\CommentTok{\# percentage of cell with less than 10\% mito}
\FunctionTok{round}\NormalTok{(}\FunctionTok{sum}\NormalTok{(pbmc}\SpecialCharTok{$}\NormalTok{percent.mt }\SpecialCharTok{\textless{}} \DecValTok{10}\NormalTok{)}\SpecialCharTok{/}\FunctionTok{dim}\NormalTok{(pbmc)[}\DecValTok{2}\NormalTok{]}\SpecialCharTok{*}\DecValTok{100}\NormalTok{,}\DecValTok{2}\NormalTok{) }
\CommentTok{\#\textgreater{} [1] 99.78}

\CommentTok{\# percentage of cell with less than 20\% mito}
\FunctionTok{round}\NormalTok{((}\FunctionTok{sum}\NormalTok{(pbmc}\SpecialCharTok{$}\NormalTok{percent.mt }\SpecialCharTok{\textless{}} \DecValTok{20}\NormalTok{)}\SpecialCharTok{/}\FunctionTok{dim}\NormalTok{(pbmc)[}\DecValTok{2}\NormalTok{])}\SpecialCharTok{*}\DecValTok{100}\NormalTok{,}\DecValTok{2}\NormalTok{)}
\CommentTok{\#\textgreater{} [1] 99.93}

\CommentTok{\# percentage of cell with less than 30\% mito}
\FunctionTok{round}\NormalTok{((}\FunctionTok{sum}\NormalTok{(pbmc}\SpecialCharTok{$}\NormalTok{percent.mt }\SpecialCharTok{\textless{}} \DecValTok{30}\NormalTok{)}\SpecialCharTok{/}\FunctionTok{dim}\NormalTok{(pbmc)[}\DecValTok{2}\NormalTok{])}\SpecialCharTok{*}\DecValTok{100}\NormalTok{,}\DecValTok{2}\NormalTok{) }
...
\NormalTok{de\_result\_wilcox}\SpecialCharTok{$}\NormalTok{AveExpr}\OtherTok{\textless{}{-}} \FunctionTok{rowMeans}\NormalTok{(kang.celltype[[}\StringTok{"RNA"}\NormalTok{]]}\SpecialCharTok{@}\NormalTok{data[}\FunctionTok{rownames}\NormalTok{(de\_result\_wilcox),])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Add average expression for plotting}
\NormalTok{de\_result\_negbinom}\SpecialCharTok{$}\NormalTok{AveExpr}\OtherTok{\textless{}{-}} \FunctionTok{rowMeans}\NormalTok{(kang.celltype[[}\StringTok{"RNA"}\NormalTok{]]}\SpecialCharTok{@}\NormalTok{data[}\FunctionTok{rownames}\NormalTok{(de\_result\_negbinom),])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} Number of nodes: 5000}
\CommentTok{\#\textgreater{} Number of edges: 171031}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} Running Louvain algorithm...}
\CommentTok{\#\textgreater{} Maximum modularity in 10 random starts: 0.9327}
\CommentTok{\#\textgreater{} Number of communities: 9}
\CommentTok{\#\textgreater{} Elapsed time: 0 seconds}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# To look at our seurat object}
\FunctionTok{str}\NormalTok{(pbmc)}

\DocumentationTok{\#\# To access the meta.data slot}
\NormalTok{pbmc}\SpecialCharTok{@}\NormalTok{meta.data}

\DocumentationTok{\#\# meta.data contains cell metadata identified by cell barcode, currently there is nFeatures and nCounts}

\DocumentationTok{\#\# the actual count data can be found by which is what we had in \textasciigrave{}pbmc.data\textasciigrave{} lots of accessors here!}

\NormalTok{pbmc}\SpecialCharTok{@}\NormalTok{assays}\SpecialCharTok{$}\NormalTok{RNA}\SpecialCharTok{@}\NormalTok{counts}
\CommentTok{\# or}
\NormalTok{pbmc}\SpecialCharTok{$}\NormalTok{RNA}\SpecialCharTok{@}\NormalTok{counts}
\CommentTok{\# or}
\NormalTok{pbmc[[}\StringTok{"RNA"}\NormalTok{]]}\SpecialCharTok{@}\NormalTok{counts}

\DocumentationTok{\#\# this is the data object in pbmc.data but is now stored within the seurat object}
\NormalTok{pbmc}\SpecialCharTok{@}\NormalTok{assays}\SpecialCharTok{$}\NormalTok{RNA}\SpecialCharTok{@}\NormalTok{counts[}\FunctionTok{c}\NormalTok{(}\StringTok{"CD3D"}\NormalTok{,}\StringTok{"TCL1A"}\NormalTok{,}\StringTok{"MS4A1"}\NormalTok{), }\DecValTok{1}\SpecialCharTok{:}\DecValTok{30}\NormalTok{]}

\CommentTok{\# The PBMC dataset is a gene{-}expression dataset and is stored in an assay called \textasciigrave{}RNA\textasciigrave{}. What other types of assays could we have stored in a Seurat object if we had a different type of dataset?}
\CommentTok{\# We could have a ATAC assay if we had done single cell ATAC}
\CommentTok{\# We could have a HTO assay if we\textquotesingle{}d done cell hashtagging}
\CommentTok{\# We could have a CSP assay if we captured cell surface protein data}
\end{Highlighting}
\end{Shaded}

\hypertarget{challenge-the-meta.data-slot-in-the-seurat-object-1}{%
\section{Challenge: The meta.data slot in the Seurat object}\label{challenge-the-meta.data-slot-in-the-seurat-object-1}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pbmc}\SpecialCharTok{$}\NormalTok{percent.riboL }\OtherTok{\textless{}{-}} \FunctionTok{PercentageFeatureSet}\NormalTok{(pbmc, }\AttributeTok{pattern =} \StringTok{"\^{}RPL"}\NormalTok{)}
\NormalTok{pbmc}\SpecialCharTok{$}\NormalTok{percent.riboS }\OtherTok{\textless{}{-}} \FunctionTok{PercentageFeatureSet}\NormalTok{(pbmc, }\AttributeTok{pattern =} \StringTok{"\^{}RPS"}\NormalTok{)}

\NormalTok{plot1 }\OtherTok{\textless{}{-}} \FunctionTok{FeatureScatter}\NormalTok{(pbmc, }\AttributeTok{feature1 =} \StringTok{"percent.riboS"}\NormalTok{, }\AttributeTok{feature2 =} \StringTok{"percent.riboL"}\NormalTok{)}
\NormalTok{plot1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pbmc}\SpecialCharTok{$}\NormalTok{lowRiboL }\OtherTok{\textless{}{-}}\NormalTok{ pbmc}\SpecialCharTok{$}\NormalTok{percent.riboL }\SpecialCharTok{\textless{}=} \DecValTok{5}
\NormalTok{plot1 }\OtherTok{\textless{}{-}} \FunctionTok{FeatureScatter}\NormalTok{(pbmc, }\AttributeTok{feature1 =} \StringTok{"nCount\_RNA"}\NormalTok{, }\AttributeTok{feature2 =} \StringTok{"percent.mt"}\NormalTok{, }\AttributeTok{group.by =} \StringTok{"lowRiboL"}\NormalTok{)}
\NormalTok{plot1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{monaco }\OtherTok{\textless{}{-}}\NormalTok{ celldex}\SpecialCharTok{::}\FunctionTok{MonacoImmuneData}\NormalTok{()}
\NormalTok{monaco.pred.fine }\OtherTok{\textless{}{-}}\NormalTok{ SingleR}\SpecialCharTok{::}\FunctionTok{SingleR}\NormalTok{(}
  \AttributeTok{test =}\NormalTok{ sce, }\AttributeTok{ref =}\NormalTok{ monaco, }\AttributeTok{labels =}\NormalTok{ monaco}\SpecialCharTok{$}\NormalTok{label.fine)}

\NormalTok{pbmc}\SpecialCharTok{$}\NormalTok{monaco\_fine }\OtherTok{\textless{}{-}}\NormalTok{ monaco.pred.fine}\SpecialCharTok{$}\NormalTok{labels}
\FunctionTok{DimPlot}\NormalTok{(pbmc, }\AttributeTok{reduction=}\StringTok{\textquotesingle{}umap\textquotesingle{}}\NormalTok{, }\AttributeTok{group.by=}\StringTok{\textquotesingle{}monaco\_fine\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
